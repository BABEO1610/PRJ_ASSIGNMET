...
public class AddAccount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        boolean success = dao.addAccount(user, pass, name, email, phone, roleId);

        if (success) {
            response.sendRedirect("Home_Admin?status=add_success");
        } else {
            request.setAttribute("error", "Không thể thêm tài khoản. Tên đăng nhập có thể đã tồn tại.");
