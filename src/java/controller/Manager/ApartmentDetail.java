    ...
    throws ServletException, IOException {
       String idRaw = request.getParameter("id");
        if (idRaw != null) {
            ...
            Apartments apt = dao.getApartmentById(id);
            
            // Tên thuộc tính phải khớp với biến ${apartment} trong JSP của bạn
            request.setAttribute("apartment", apt); 
        }
        request.getRequestDispatcher("/Manager/apartmentdetail.jsp").forward(request, response);
    }
