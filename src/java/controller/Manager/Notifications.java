...
public class Notifications extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id_raw != null) {
            ...
            request.getRequestDispatcher("/Manager/notification-detail.jsp").forward(request, response);
            return;
        }

        List<model.Notifications> list = dao.getAllNotifications();
        request.setAttribute("listNotif", list);
        request.getRequestDispatcher("/Manager/notification.jsp").forward(request, response);
    }
