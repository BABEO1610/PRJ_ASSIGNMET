...
public class TaskDetail extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Requests task = dao.getRequestById(requestId);

        request.setAttribute("task", task);

        request.getRequestDispatcher("/Staff/TaskDetail.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        if ("complete".equals(action)) {
            ...
            dao.updateStatus(requestId, "Completed");
