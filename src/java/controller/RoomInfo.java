...
public class RoomInfo extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RoomInfo</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RoomInfo at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            model.Apartments myRoom = dao.getApartmentByResidentId(user.getUserId());
