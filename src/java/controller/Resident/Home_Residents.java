...
public class Home_Residents extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id_raw != null) {
            ...
            request.getRequestDispatcher("/Resident/notification_detail_Residents.jsp").forward(request, response);
            return;
        }
        
        // 7. Chuyển hướng sang trang residentHome.jsp
        request.getRequestDispatcher("/Resident/Home_Residents.jsp").forward(request, response);
    }
}