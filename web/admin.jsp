...
<div class="full-page-content">
    <div class="data-container">
        ...
        <div class="footer-actions">
            <button class="btn btn-logout" onclick="window.location.href='Logout'">Đăng xuất</button>
            <button class="btn btn-main-add" onclick="window.location.href='add-account.jsp'">+ Thêm tài khoản mới</button>
        </div>
    </div>
</div>
