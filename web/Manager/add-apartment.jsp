...
<div class="app-container">
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/Home" class="menu-item active">Trang chủ</a>
        <a href="${pageContext.request.contextPath}/Apartments" class="menu-item">Quản lý căn hộ</a>
        <a href="${pageContext.request.contextPath}/Employees" class="menu-item">Quản lý nhân viên</a>
        <a href="${pageContext.request.contextPath}/Requests" class="menu-item">Quản lý yêu cầu cư dân</a>
        <a href="${pageContext.request.contextPath}/Notifications" class="menu-item">Thông báo</a>
        <a href="${pageContext.request.contextPath}/Logout" class="menu-item" style="margin-top: 20px;">Đăng xuất</a>
    </div>
    ...
    <div class="main-content">
        <div class="content-section">
            ...
            <div class="form-container">
                <form action="${pageContext.request.contextPath}/AddApartmentController" method="POST">
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn btn-delete" onclick="window.location.href='${pageContext.request.contextPath}/Apartments'">Hủy bỏ</button>
