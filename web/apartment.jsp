    ...
    <div class="app-container">
        ...
        <div class="main-content">
            <div class="content-section">
                <div class="section-header"><h3>Danh sách căn hộ</h3></div>
                    ...
                    <tbody>
                        <c:forEach items="${listApts}" var="a">
                            <tr id="row-${a.apartmentId}">
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-view" onclick="window.location.href='ApartmentDetail?id=${a.apartmentId}'">Chi tiết</button>
